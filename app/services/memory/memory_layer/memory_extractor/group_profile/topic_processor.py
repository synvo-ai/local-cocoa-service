...
from services.memory.common_utils.datetime_utils import get_now_with_timezone, from_iso_format
...
class TopicProcessor:
    ...
    def get_latest_memcell_timestamp(
        ...
        """
        from services.memory.memory_layer.memory_extractor.group_profile_memory_extractor import convert_to_datetime
    ...
    def apply_topic_incremental_updates(
        ...
        """
        from services.memory.memory_layer.memory_extractor.group_profile_memory_extractor import TopicInfo
