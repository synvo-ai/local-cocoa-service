"""Group Profile Memory Extraction for SynvoMem."""
...
from services.memory.api_specs.memory_types import BaseMemory, MemoryType, MemCell
from services.memory.common_utils.datetime_utils import (
...
class GroupProfileMemoryExtractor(MemoryExtractor):
    ...
    def data_processor(self):
        ...
        if self._data_processor is None:
            from services.memory.memory_layer.memory_extractor.group_profile.data_processor import GroupProfileDataProcessor
    ...
    def topic_processor(self):
        ...
        if self._topic_processor is None:
            from services.memory.memory_layer.memory_extractor.group_profile.topic_processor import TopicProcessor
    ...
    def role_processor(self):
        ...
        if self._role_processor is None:
            from services.memory.memory_layer.memory_extractor.group_profile.role_processor import RoleProcessor
    ...
    def llm_handler(self):
        ...
        if self._llm_handler is None:
            from services.memory.memory_layer.memory_extractor.group_profile.llm_handler import GroupProfileLLMHandler
