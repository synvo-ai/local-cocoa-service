...
Usage:
    from services.memory.memory_layer.profile_manager import ProfileManager, ProfileManagerConfig
...
from services.memory.memory_layer.profile_manager.config import ProfileManagerConfig, ScenarioType
from services.memory.memory_layer.profile_manager.manager import ProfileManager
