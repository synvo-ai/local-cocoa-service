...
from services.memory.common_utils.language_utils import (
    get_prompt_language,
...
_PROMPT_REGISTRY = {
    ...
    "CONV_BOUNDARY_DETECTION_PROMPT": {
        "en": ("services.memory.memory_layer.prompts.en.conv_prompts", False),
        "zh": ("services.memory.memory_layer.prompts.zh.conv_prompts", False),
    },
    "CONV_SUMMARY_PROMPT": {
        "en": ("services.memory.memory_layer.prompts.en.conv_prompts", False),
        "zh": ("services.memory.memory_layer.prompts.zh.conv_prompts", False),
    ...
    "EPISODE_GENERATION_PROMPT": {
        "en": ("services.memory.memory_layer.prompts.en.episode_mem_prompts", False),
        "zh": ("services.memory.memory_layer.prompts.zh.episode_mem_prompts", False),
    },
    ...
    "CONVERSATION_PROFILE_EXTRACTION_PROMPT": {
        "en": ("services.memory.memory_layer.prompts.en.profile_mem_prompts", False),
        "zh": ("services.memory.memory_layer.prompts.zh.profile_mem_prompts", False),
    },
    "CONVERSATION_PROFILE_PART1_EXTRACTION_PROMPT": {
        "en": ("services.memory.memory_layer.prompts.en.profile_mem_part1_prompts", False),
        "zh": ("services.memory.memory_layer.prompts.zh.profile_mem_part1_prompts", False),
    },
    "CONVERSATION_PROFILE_PART2_EXTRACTION_PROMPT": {
        "en": ("services.memory.memory_layer.prompts.en.profile_mem_part2_prompts", False),
        "zh": ("services.memory.memory_layer.prompts.zh.profile_mem_part2_prompts", False),
    },
    "CONVERSATION_PROFILE_PART3_EXTRACTION_PROMPT": {
        "en": ("services.memory.memory_layer.prompts.en.profile_mem_part3_prompts", False),
        "zh": ("services.memory.memory_layer.prompts.zh.profile_mem_part3_prompts", False),
    },
    "CONVERSATION_PROFILE_EVIDENCE_COMPLETION_PROMPT": {
        "en": ("services.memory.memory_layer.prompts.en.profile_mem_evidence_completion_prompt", False),
        "zh": ("services.memory.memory_layer.prompts.zh.profile_mem_evidence_completion_prompt", False),
    },
    # Group Profile
    "CONTENT_ANALYSIS_PROMPT": {
        "en": ("services.memory.memory_layer.prompts.en.group_profile_prompts", False),
        "zh": ("services.memory.memory_layer.prompts.zh.group_profile_prompts", False),
    },
    ...
    "get_foresight_generation_prompt": {
        "en": ("services.memory.memory_layer.prompts.en.foresight_prompts", True),
        "zh": ("services.memory.memory_layer.prompts.zh.foresight_prompts", True),
    },
    ...
    # Event Log
    "EVENT_LOG_PROMPT": {
        "en": ("services.memory.memory_layer.prompts.en.event_log_prompts", False),
        "zh": ("services.memory.memory_layer.prompts.zh.event_log_prompts", False),
    },
}
