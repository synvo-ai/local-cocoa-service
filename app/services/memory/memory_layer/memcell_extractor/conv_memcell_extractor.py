"""
Simple Boundary Detection Base Class for SynvoMem
...
from services.memory.memory_layer.memcell_extractor.base_memcell_extractor import (
    MemCellExtractor,
    RawData,
    MemCell,
    StatusResult,
...
class ConvMemCellExtractor(MemCellExtractor):
    ...
    def _get_tokenizer(cls):
        """Get a tiktoken tokenizer if available."""
        if tiktoken is None:
            return None
